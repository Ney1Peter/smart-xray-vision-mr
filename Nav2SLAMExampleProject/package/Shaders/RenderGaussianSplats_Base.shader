...
Shader "Gaussian Splatting/Render Splats Base"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _CutCenterR;   // xyz = center of the hole, w = radius
            float  _CutMinAlpha;  // Minimum alpha at center (0~1). 0 = fully transparent

            #define FADE_ALPHA   // ← Uncomment to enable alpha fading; keep commented for hard cut
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                half4 res;
                res.a   = finalAlpha;
                res.rgb = i.col.rgb * finalAlpha;  // Premultiplied alpha
                return res;
            }
