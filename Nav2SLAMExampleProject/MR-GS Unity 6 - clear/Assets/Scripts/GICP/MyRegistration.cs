...
public class MyRegistration : MonoBehaviour
{
    ...
    [DllImport("SimpleGICP.dll", CallingConvention = CallingConvention.Cdecl)]
    private static extern SimpleGICP RunGICP(
    ...
    private Matrix4x4 GetFinalTransformation(SimpleGICP result)
    {
